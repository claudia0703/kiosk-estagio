...
import { CATEGORY_LIST_FAIL, CATEGORY_LIST_REQUEST, CATEGORY_LIST_SUCCESS, ORDER_ADD_ITEM, ORDER_CLEAR, ORDER_REMOVE_ITEM, ORDER_SET_PAYMENT_TYPE, ORDER_SET_TYPE, PRODUCT_LIST_FAIL, PRODUCT_LIST_REQUEST, PRODUCT_LIST_SUCCESS, ORDER_CREATE_REQUEST, ORDER_CREATE_SUCCESS, ORDER_CREATE_FAIL, ORDER_QUEUE_LIST_SUCCESS, ORDER_QUEUE_LIST_FAIL, ORDER_LIST_FAIL, ORDER_QUEUE_LIST_REQUEST, ORDER_LIST_REQUEST, ORDER_LIST_SUCCESS, SCREEN_SET_WIDTH } from './constants';
...
function reducer(state, action){
    ...
    case ORDER_QUEUE_LIST_SUCCESS:
                    return {
                        ...state, queueList: { loading: false, queue: action.payload },
                    };
    case ORDER_QUEUE_LIST_FAIL:
                    return {
                        ...state, queueList: { loading: false, error: action.payload },
                    };
